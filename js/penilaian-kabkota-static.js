/* ===========================================================
   Penilaian Kabupaten/Kota - Formulir Validasi dan Verifikasi
...
(function(){
  ...
  // Kriteria kelulusan tetap menggunakan kriteria yang sama dengan penilaian mandiri
  ...
  // Fungsi validasi - tambahan khusus untuk penilaian kab/kota
  var VALIDATION_RULES = {
    maxDeviation: 10, // Maksimal deviasi dari skor penilaian mandiri (dalam %)
    minSectionScore: 0.6 // Minimal 60% dari skor maksimal per bagian
  };
  // ==============  A. FORM CONFIG  =================
  var FORM_CONFIG = [
    {
...

{
  ...
  var totalSkorEl = document.getElementById('kabTotalScore');
  var sectionSkorEl = document.getElementById('kabSectionScore');
  var kategoriOutEl = document.getElementById('kabStatus');
